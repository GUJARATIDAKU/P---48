class B1F2{
    ...
    display(){
        ...
        this.p11.html("Tobacco intake")
        this.p11.position(100,200);

     
        this.p12.html("Lack of physical activity")
        this.p12.position(100,250);

        
        this.p13.html("Poor diet")
        ...
        this.p15.html("High BP or Cholesterol")
        this.p15.position(100,400);

        
        this.p16.html("Overweight")
        this.p16.position(100,450);

      
        this.p17.html("Family history of CVD")
