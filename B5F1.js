class B5F1{
    constructor(){
        ...
        this.image = createElement("img").attribute("src","Images/diabetes_img.png");  
    ...
    display(){
        ...
        this.p1.html("Extreme hunger")
        this.p1.position(100,200);

    
        this.p2.html("Unexplained weight loss")
        this.p2.position(100,250);

        
        this.p3.html("Fatigue")
        this.p3.position(100,300);

     
        this.p4.html("Increased thirst")
        this.p4.position(100,350);

   
        this.p5.html("Frequent urination")
        this.p5.position(100,400);

        
        this.p6.html("Irritability")
