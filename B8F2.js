class B8F2{
    ...
    display(){
        ...
        this.p11.html("No access to clean water.")
        this.p11.position(100,200);

      
        this.p12.html("Living in an area with poor sanitation facilities.")
        this.p12.position(100,250);

    
        this.p13.html("Malnourishment.")
        this.p13.position(100,300);


        this.p14.html("Weak immune system .")
        this.p14.position(100,350);

   
        this.p15.html("Preventive Measures and Diets for Diarrheal Diseases.")
