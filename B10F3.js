class B10F3{
    ...
    display(){
        ...
        this.p21.html("Do not smoke")
        this.p21.position(100,200);

      
        this.p22.html("Know your family history")
        this.p22.position(100,250);

        
        this.p23.html("Protect yourself against dust, fumes and chemicals at home or at work")
        this.p23.position(100,300);


        this.p24.html("Avoid air pollution")
